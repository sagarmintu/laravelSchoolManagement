                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" placeholder="Enter Mobile Number" name="admission_date" value="{{ old('admission_date', $getRecord->admission_date) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <p style="font-weight: bold;">Do You Want To Change The Password ? Then Add New Password</p>
                                </div>
                            </div>
