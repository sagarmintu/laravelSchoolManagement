...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="javascript:void(0)" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Ralecon</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{ url('teacher/exam_timetable') }}" class="nav-link @if(Request::segment(2) == 'exam_timetable') active @endif">
        ...
        <li class="nav-item">
          <a href="{{ url('student/exam_results') }}" class="nav-link @if(Request::segment(2) == 'exam_results') active @endif">
            <i class="nav-icon fas fa-columns"></i>
            <p>Exam Results</p>
          </a>
        </li>
