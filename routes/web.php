...
Route::group(['middleware' => 'admin'], function() {
    ...
    Route::get('admin/parent/add_student_to_parent/{student_id}/{parent_id}', [ParentController::class, 'AddStudentToParent']);
    Route::get('admin/parent/add_student_to_parent_delete/{student_id}', [ParentController::class, 'deleteStudentToParent']);
    ...
    Route::get('admin/examinations/exam/add', [ExaminationsController::class, 'add_exam']);
    Route::post('admin/examinations/exam/add', [ExaminationsController::class, 'insert_exam']);
    Route::get('admin/examinations/exam/edit/{id}', [ExaminationsController::class, 'edit_exam']);
    Route::post('admin/examinations/exam/edit/{id}', [ExaminationsController::class, 'update_exam']);
...
Route::group(['middleware' => 'student'], function() {
    ...
    Route::get('student/exam_results', [ExaminationsController::class, 'exam_results']);
});
...
Route::group(['middleware' => 'parent'], function() {
    ...
    Route::get('parent/my_student/exam_timetable/{student_id}', [ExaminationsController::class, 'examTimetableParent']);
